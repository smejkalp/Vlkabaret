...
User.create(:firstName =>'Alžběta', :lastName => 'Kostrhounová', :role_id => member.id)
User.create(:firstName =>'Jakub', :lastName => 'Otčenášek', :role_id => member.id)
User.create(:firstName =>'Antonín', :lastName => 'Policar', :role_id => member.id)
